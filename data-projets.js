  ...
  exercices: [
    {
      ...
      indice: 'Le squelette de l\'écouteur :<br><code>let texte = champ.value;<br>if (texte === "") { return; }<br>let li = document.createElement("li");<br>li.textContent = texte;<br>li.addEventListener("click", function () { li.remove(); });<br>liste.appendChild(li);<br>champ.value = "";</code>',
    ...
    },
    {
      ...
      indice: 'Écris une fonction <code>majCompteur()</code> qui fait : <code>document.querySelector("#compteur").textContent = liste.querySelectorAll("li").length + " tâche(s) restante(s)";</code> — puis appelle-la après l\'appendChild ET après le remove.',
